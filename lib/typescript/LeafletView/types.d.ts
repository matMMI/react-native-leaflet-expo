...
export declare const OWN_POSTION_MARKER_ID = "OWN_POSTION_MARKER_ID";
export declare enum WebViewLeafletEvents {
...
export declare enum MapShapeType {
    CIRCLE = "Circle",
...
export declare const INFINITE_ANIMATION_ITERATIONS: string;
